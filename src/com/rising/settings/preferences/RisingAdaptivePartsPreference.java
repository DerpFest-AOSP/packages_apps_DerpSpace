...
public class RisingAdaptivePartsPreference extends LineagePartsPreference {
    
    private Position position;

    public RisingAdaptivePartsPreference(Context context, AttributeSet attrs,
                            int defStyle, int defStyleRes) {
        super(context, attrs, defStyle, defStyleRes);
        init(context, attrs);
    }

    public RisingAdaptivePartsPreference(Context context, AttributeSet attrs, int defStyle) {
