...
import org.derpfest.derpspace.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_derpspace_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_derpspace_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_derpspace_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_derpspace_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_derpspace_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_derpspace_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_derpspace_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_derpspace_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_derpspace_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_derpspace_colorActive, colorActive);
                titleColorActive = ta.getColor(R.styleable.BubbleToggleView_derpspace_titleColorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_derpspace_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_derpspace_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_derpspace_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_derpspace_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_derpspace_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
